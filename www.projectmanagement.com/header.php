        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
          <div class="container-fluid">
            ...
            <div class="logo"><a href="index" class="remove-decoration myLogo">
              <img src="files/images/logo.png" width=50 height=50 class="img-fluid logo-image">
              </a>
            </div>
            ...
            <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
              ...
              <li class="nav-item">
                <a class="nav-link" aria-current="page" href="index.php"><span class="bi bi-house"></span>&nbsp;Home</a>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="mission_vission.php">Mission</a></li>
                  <li><a class="dropdown-item" href="mission_vission.php">Vission</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="project_advisors_chancellors.php">Project Advisors/Chancellor</a></li>
                  <li><a class="dropdown-item" href="project_planning.php">Project Planning</a></li>
                  <li><a class="dropdown-item" href="project_market.php">Project Market</a></li>
                  <li><a class="dropdown-item" href="project_management_workshop.php">Project Management Workshop</a></li>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="annual_report.php">Annual Report</a></li>
              ...
              <li class="nav-item">
                <a class="nav-link" href="contact.php"><span class="bi bi-person-video2"></span>&nbsp;
                    Contact Us</a>
              </li>
